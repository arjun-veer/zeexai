  ...
  return (
    <footer className="bg-gradient-to-bottom">
      <div className="m-auto flex max-w-[90rem] justify-between px-24 py-32 max-xl:px-16 max-xl:py-24 max-lg:grid max-lg:gap-y-18 max-lg:px-8 max-md:px-6 max-sm:pb-16">
        <div className="pr-8 ">
          <a className="flex items-center mb-11  gap-x-3 max-md:gap-x-2" href="#">
            <Logo
          ...
          <div className="text-primary-50  text-xl/loose font-semibold max-md:text-lg/8 max-md:tracking-tight">
          <p  className="text-primary-50 hover:text-primary-500 transition-properties text-lg/8 font-light max-xl:text-base/loose">
          Zeex AI is a leading innovator in AI-powered safety and surveillance, dedicated to creating secure environments through advanced real-time intelligence and cutting-edge technology.
            </p>
            </div>
        </div>
